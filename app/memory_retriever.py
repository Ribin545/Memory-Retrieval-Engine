"""
Memory Retrieval Engine — Memory Retriever
...
print(f"[INFO] Eagerly loading {EMBEDDING_MODEL} to prevent OpenMP deadlocks...")
_model = SentenceTransformer(EMBEDDING_MODEL, device='cpu')
_model.encode("warmup")
print(f"[INFO] {EMBEDDING_MODEL} loaded and warmed up successfully.")

def get_model():
    """
    Lazy-load the sentence-transformer embedding model.
    (Now eager-loaded to prevent deadlocks)
    """
    return _model
